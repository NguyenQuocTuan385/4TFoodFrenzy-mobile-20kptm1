...
class AddRecipeActivity4 : AppCompatActivity() {
    ...
    private fun createStepList():ArrayList<CookingStep>{
        val list= arrayListOf<CookingStep>()
        for (i in 1..6) {
            list.add(CookingStep(1,"Lọc bớt mỡ và rửa sạch miếng thịt lợn sữa", R.drawable.monan1))
        }
        return list
    }
