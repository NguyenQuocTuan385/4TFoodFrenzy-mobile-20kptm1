...
// Gán tên file cho drawable
//        val drawableName = "bokho"
//
//// Tạo đường dẫn đến tệp tin trên Cloud Storage
//        val filename = "$drawableName.jpg"
...
//
//// Thêm một listener để theo dõi tiến trình tải lên
//        uploadTask.addOnCompleteListener { task ->
//            if (task.isSuccessful) {
//                // Tải lên thành công, do something
//            } else {
