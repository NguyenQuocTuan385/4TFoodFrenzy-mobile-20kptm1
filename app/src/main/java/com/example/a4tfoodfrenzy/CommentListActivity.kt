...
class CommentListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cmtList.add(RecipeComment("Đặng Ngọc Tiến", "", R.drawable.avt,true, R.drawable.comrangduabo,"Rất ngon và đơn giản", "3 ngày trước"))
        cmtList.add(RecipeComment("Đặng Ngọc Tiến", "", R.drawable.avt,true, 0,"Đẹp quá", "3 ngày trước"))
        cmtList.add(RecipeComment("Trương Gia Tiến", "", R.drawable.avt,true, 0,"Ngon như Hiền Phương ??", "1 giờ trước"))
        cmtList.add(RecipeComment("Nguyễn Văn Việt", "", R.drawable.avt,true, R.drawable.mitrungxaobo,"Ngon như Trần Nhi nhà em vậydâdadadasdsadasdasdasdsadasdadasdsdadsad", "7 ngày trước"))
